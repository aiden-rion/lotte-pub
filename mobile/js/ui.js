...
const ui = {
    ...
    mainCard : function () {
        var $card = $('.hot-search-slider .swiper-slide');
        var lastCard = $(".hot-search-slider .swiper-wrapper .swiper-slide").length - 1;
    ...
    tab : function (){
        $(".tab button").click(function (){
            var tabGroup = $(this).closest(".tab-wrap");
