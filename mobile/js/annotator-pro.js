...
;(function ( $, window, document, undefined ) {
        ...
        init : function() {
            ...
            self.img.onload = function() {
                ...
                self.obj_content.css({
                    ...
                    "left" : -self.contentWidth/4 + self.frameWidth/4 + "px",
    ...
    NDD_Annotation.prototype = {
        init : function() {
            ...
            let box = self.obj_popup_container.find('.ndd-popup-box')[0];
            box.setAttribute("data-location",self.options.location?self.options.location:"");
