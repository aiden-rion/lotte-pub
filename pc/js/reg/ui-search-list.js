$(function(){
	...
	// 	var footerTop = jQuery(".footer-content").offset().top - 1300,
	// 		topHg = jQuery(".ctn-search-list").offset().top + 210;	// ### 230726 숫자(padding)값 수정
	//
	...
	$(".bt-btn-login, .sdwBg").click(function(){
